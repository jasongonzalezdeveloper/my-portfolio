  ...
  return (
    <SectionWrapper id="contact" ariaLabelledBy="contact-heading">
      <div className="max-w-lg mx-auto text-center">
        <h2
          id="contact-heading"
          className="text-3xl sm:text-4xl font-bold text-[#e8f0fe] mb-4"
        >
          {t("contact.heading")}
        ...
        >
          <a
            ...
            className="flex items-center gap-2 w-full sm:w-auto justify-center
                       ...
                       bg-[#00d4ff] text-[#080d1a] hover:bg-white
                       transition-colors duration-200 min-h-[44px] shadow-lg shadow-[#00d4ff]/20"
          >
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full
                        border border-[#22c55e]/20 bg-[#22c55e]/5">
          <span
            aria-hidden="true"
