  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl w-full space-y-6">
        ...
        <motion.p
          {...fadeUp(0.1)}
          className="text-[#00d4ff] text-sm font-semibold tracking-[0.2em] uppercase"
        >
          7+ years in frontend
        </motion.p>
        ...
        <motion.h1
          id="hero-heading"
          {...fadeUp(0.2)}
          className="text-5xl sm:text-6xl md:text-7xl font-bold text-[#e8f0fe] leading-tight"
        >
          {t("hero.greeting")}
        </motion.h1>
        ...
        <motion.div
          ...
          aria-live="polite"
          aria-atomic="true"
          className="text-xl sm:text-2xl md:text-3xl font-medium text-[#7a8ba8] min-h-[2.5rem]"
        >
        ...
        >
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-full font-semibold text-sm
                       bg-[#00d4ff] text-[#080d1a] hover:bg-white transition-colors duration-200
                       min-h-[44px] shadow-lg shadow-[#00d4ff]/20"
          >
        ...
        <motion.a
          ...
          className="inline-flex flex-col items-center gap-2 pt-8 text-[#7a8ba8]
                     hover:text-[#00d4ff] transition-colors duration-200 group"
        >
